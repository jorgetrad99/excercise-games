...
- Menu → **Body scan**: stand still, then T-pose; saves arm lengths under the player name (`ProfileStore` v2). Currently stored but not applied to reach (PLAN-BOXING BX-CAL-6 blocker).
