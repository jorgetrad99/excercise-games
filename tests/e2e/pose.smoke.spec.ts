...
test('fake camera clip is tracked by the worker pipeline at >= 20 pose-fps for 5 s', async ({
  page,
}) => {
  ...
  expect(fixture).toMatchObject({ version: 1, model: 'full', video: { width: 1280, height: 720 } });
