...
export const boxingConfig = {
  ...
  body: {
     ...
     * glove that crosses the ring. At 1.2 a guard (wrist ~0.45 arm forward) stays ~30 cm short of the
     * opponent's face and a punch reaches it at ~70 % extension.
     */
    armGainM: { forward: 1.2, side: 0.7, up: 0.7 },
     ...
     * Above a guard (wrist ~0.45 arm forward → z ≈ 0.69) so a jab from the guard re-arms; below the
